...
const CUSTOM_SECTORS = {
    ...
    'Textiles':           ['PAGEIND','RAYMOND','ARVIND','TRIDENT','WELSPUN','VTL','RUPA','SPORTKING','SUTLEJTEX','HIMATSEIDE'],
...
const CUSTOM_STOCK_NAMES = {
    ...
    'VTL':'Vardhman Textiles Ltd','SUTLEJTEX':'Sutlej Textiles & Industries','WELSPUN':'Welspun India Ltd',
};
